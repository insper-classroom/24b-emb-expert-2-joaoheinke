...
/* Função de compensação de pressão */
...
/* Função de compensação de umidade */
...
int main() {
    ...
    int32_t humidity, pressure, temperature, t_fine;
    ...
    while (1) {
        ...
        temperature = compensate_temp(temperature, &t_fine);
        pressure = compensate_pressure(pressure, t_fine);
        humidity = compensate_humidity(humidity, t_fine);
